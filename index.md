...
### [Membuat Database SQLite Web Absensi dengan Node.js](pages/membuat-database-sqlite-web-absensi-dengan-nodejs.md)

**📅 Dipublikasikan: 7 April 2026**

Tutorial lengkap untuk membuat database SQLite untuk sistem absensi mahasiswa menggunakan Node.js dan better-sqlite3. Artikel ini mencakup:

- **Persiapan Project** - Setup Node.js dan inisialisasi project
- **Instalasi Dependencies** - Better-sqlite3, Express, dan Nodemon
- **Struktur Database** - 8 tabel utama yang saling berelasi
- **Diagram Relasi** - Visualisasi hubungan antar tabel
- **Tabel Pengguna** - Admin, dosen, dan mahasiswa dengan role-based access
- **Tabel Mahasiswa & Dosen** - Data spesifik dengan foreign key ke pengguna
- **Mata Kuliah dan Kelas** - Manajemen course dan class scheduling
- **Peserta Kelas** - Many-to-many relationship antara mahasiswa dan kelas
- **Sesi Absensi** - Pertemuan kelas dengan tanggal dan kode QR
- **Record Absensi** - Status kehadiran (hadir, izin, sakit, alpha)
- **Foreign Key Constraints** - Menjaga integritas referensial data
- **Penjelasan Kode Detail** - Line-by-line explanation untuk pemula

Tutorial ini sangat cocok untuk mahasiswa atau developer yang ingin belajar membuat sistem database relasional dengan SQLite dan Node.js, khususnya untuk aplikasi attendance management.

**📖 [Baca Selengkapnya →](pages/membuat-database-sqlite-web-absensi-dengan-nodejs.md)**
