...
1. [Pengantar DBML](#pengantar-dbml)
2. [Mengapa Menggunakan DBML?](#mengapa-menggunakan-dbml)
3. [Syntax Dasar DBML](#syntax-dasar-dbml)
4. [Mendefinisikan Tabel dan Kolom](#mendefinisikan-tabel-dan-kolom)
5. [Tipe Data dan Constraints](#tipe-data-dan-constraints)
6. [Mendefinisikan Relasi](#mendefinisikan-relasi)
7. [Indexes dan Keys](#indexes-dan-keys)
8. [Enum dan Table Groups](#enum-dan-table-groups)
9. [Tools dan Platform](#tools-dan-platform)
10. [Contoh Project Lengkap](#contoh-project-lengkap)
11. [Export ke SQL](#export-ke-sql)
...
- DBML Quick Start Guide
- Database Design Best Practices
- SQL vs DBML Comparison
- Version Control for Database Schemas

### Community

- GitHub Issues & Discussions
- Stack Overflow: `#dbml` tag
- Developer Forums
